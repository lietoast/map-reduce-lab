...
type ReportServiceClient interface {
	Report(ctx context.Context, in *ReportRequest, opts ...grpc.CallOption) (*ReportResonse, error)
}
...
func (c *reportServiceClient) Report(ctx context.Context, in *ReportRequest, opts ...grpc.CallOption) (*ReportResonse, error) {
	out := new(ReportResonse)
...
type ReportServiceServer interface {
	Report(context.Context, *ReportRequest) (*ReportResonse, error)
...
func (UnimplementedReportServiceServer) Report(context.Context, *ReportRequest) (*ReportResonse, error) {
